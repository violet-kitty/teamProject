...
<!-- 결제 api --><script type="text/javascript" src="https://cdn.iamport.kr/js/iamport.payment-1.1.8.js"></script>
		...
		<div id="container" class="hbg-whitegray">
			...
			<div class="contents content01">
				...
				<div class="container" style="width:400px;">
					...
					<a id="cancel" class="onlypc" href="javascript:void(0)">
						<div class="backto">
						...
						<div class="col"> 
							<form>
								...
								<div style="text-align:center;">
									<button type="button" class="bluebtn" style=" border-radius:10px; onclick="tradeFn()">결제하기</button>
								</div>
							</form>
						</div>
					</div>
