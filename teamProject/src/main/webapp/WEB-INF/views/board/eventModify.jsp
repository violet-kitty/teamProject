...
<body>
	<div id="wrap" class="boardWrite event eventfWrite">
					...
					<form method="post" enctype="multipart/form-data" id="frm">
						...
						<div class="row imgThumbView2">
							<div class="col">
								...
								<div id="imageArea">
									<img src="<%=request.getContextPath() %>/event/displayFile.do?fileName=${event.filename}" width="100%" height="100%" id="image" style="cursor:pointer">
						...
						<div class="row  h-input">
							...
							<div class="col-lg-10 d-flex">
								<input type="date" class="form-control me-3" id="startday" name="startday" placeholder="시작 날짜" value="${event.startday}">
								<p>~</p>
								<input type="date" class="form-control ms-3" id="endday" name="endday" placeholder="종료 날짜"  value="${event.endday}">
							</div>
						</div><!-- /row -->
						...
						<div class="row h-input">
							...
							<div class="col-lg-8 titlearea">
								<input class="form-control textinput2" type="text" name="title" id="title" value="${event.title}"placeholder="제목을 작성해주세요">
							</div>
						</div><!-- row end -->
