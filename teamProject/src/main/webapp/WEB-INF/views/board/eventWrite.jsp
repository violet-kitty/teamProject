...
<script>
	...
	function visible(select){
		var s1 = ["서울특별시"];
		var s2 = ["인천광역시"];
		var s3 = ["고양시","과천시","광명시","광주시","구리시","군포시","김포시","남양주시","동두천시","부천시","성남시","수원시","시흥시","안산시","안성시","안양시","양주시","오산시","용인시","의왕시","의정부시","이천시","파주시","평택시","포천시","하남시","화성시"];
		var s4 = ["강릉시","동해시","삼척시","속초시","원주시","춘천시","태백시"];
		var s5 = ["제천시","청주시","충주시"];
		var s6 = ["계룡시","공주시","논산시","당진시","보령시","서산시","아산시","천안시"];
		var s7 = ["세종시"];
		var s8 = ["대전광역시"];
		var s9 = ["군산시","김제시","남원시","익산시","전주시","정읍시"];
		var s10 = ["광양시","나주시","목포시","순천시","여수시"];
		var s11 = ["광주광역시"];
		var s12 = ["경산시","경주시","구미시","김천시","문경시","상주시","안동시","영주시","영천시","포항시"];
		var s13 = ["대구광역시"];
		var s14 = ["거제시","김해시","밀양시","사천시","양산시","진주시","창원시","통영시"];
		var s15 = ["울산광역시"];
		var s16 = ["부산광역시"];
		var s17 = ["제주도","서귀포시"];
